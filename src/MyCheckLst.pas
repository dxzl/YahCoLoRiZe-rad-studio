...
function TMyCheckListBox.GetItemData(Index: Integer): TListBoxItemData;
begin
  Result := 0;
  if HaveWrapper(Index) then
...
procedure TMyCheckListBox.SetItemData(Index: Integer; AData: TListBoxItemData);
var
